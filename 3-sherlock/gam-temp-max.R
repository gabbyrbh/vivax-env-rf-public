...
# @File         : gam-temp-max.R
# @Description  : Primary DLNM-GAM for weekly maximum temperature with 1,000
...
saveRDS(base_result, file = paste0(results_path, "base-temp-max.RDS"))
...
saveRDS(boot_results, file = paste0(results_path, "bs-temp-max.RDS"))
