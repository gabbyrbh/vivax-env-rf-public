...
# @File         : gam-temp-max-comm-type.R
# @Description  : DLNM-GAM for maximum temperature stratified by community type
...
# Run analysis for max temp with riverine communities
...
# Run analysis for max temp with highway communities
