...
saveRDS(boot_results, file = paste0(results_path, "bs-temp-max-enso-normal.RDS"))
...
boot_results <- bootstrap_incidence_parallel(analysis_data, pred_seq, predictor, lag_value, covariate, cores_per_worker, n_boot = 1000)
saveRDS(boot_results, file = paste0(results_path, "bs-temp-max-enso-el-nino.RDS"))
...
boot_results <- bootstrap_incidence_parallel(analysis_data, pred_seq, predictor, lag_value, covariate, cores_per_worker, n_boot = 1000)
saveRDS(boot_results, file = paste0(results_path, "bs-temp-max-enso-la-nina.RDS"))
