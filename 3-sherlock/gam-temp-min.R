...
# @File         : gam-temp-min.R
# @Description  : Primary DLNM-GAM for weekly minimum temperature with 1,000
...
saveRDS(base_result, file = paste0(results_path, "base-temp-min.RDS"))
...
saveRDS(boot_results, file = paste0(results_path, "bs-temp-min.RDS"))
