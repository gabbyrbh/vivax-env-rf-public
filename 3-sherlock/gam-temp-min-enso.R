...
saveRDS(boot_results, file = paste0(bs_path, "bs-temp-min-enso-normal.RDS"))
...
boot_results <- bootstrap_incidence_parallel(analysis_data, pred_seq, predictor, lag_value, covariate, cores_per_worker, n_boot = 1000)
saveRDS(boot_results, file = paste0(bs_path, "bs-temp-min-enso-el-nino.RDS"))
...
boot_results <- bootstrap_incidence_parallel(analysis_data, pred_seq, predictor, lag_value, covariate, cores_per_worker, n_boot = 1000)
saveRDS(boot_results, file = paste0(bs_path, "bs-temp-min-enso-la-nina.RDS"))
