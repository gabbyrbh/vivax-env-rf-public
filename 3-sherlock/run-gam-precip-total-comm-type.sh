...
# @File         : run-gam-precip-total-comm-type.sh
# @Description  : SLURM submission script for gam-precip-total-comm-type.R
#                 (DLNM-GAM for total precipitation stratified by community
#                 type) on Sherlock HPC.
# ==============================================================================
...
R CMD BATCH --no-save gam-precip-total-comm-type.R gam-precip-total-comm-type.out