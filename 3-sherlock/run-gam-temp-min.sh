...
# @File         : run-gam-temp-min.sh
# @Description  : SLURM submission script for gam-temp-min.R (primary DLNM-GAM
#                 for minimum temperature with bootstrap CIs) on Sherlock HPC.
# ==============================================================================
...
R CMD BATCH --no-save gam-temp-min.R gam-temp-min.out