...
# @File         : gam-precip-total-comm-type.R
# @Description  : DLNM-GAM for total precipitation stratified by community type
...
# Run analysis for precipitation with riverine communities
results_precip_riverine <- run_analysis(
  data = nonlagged_data,
...
# Run analysis for precipitation with highway communities
results_precip_road <- run_analysis(
  data = nonlagged_data,
  predictor = "precip_wk_total", 
  lag_value = 11,
  covariate = "temp_wk_min",
